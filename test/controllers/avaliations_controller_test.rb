...
class AvaliationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create avaliation" do
    assert_difference('Avaliation.count') do
      post avaliations_url, params: { avaliation: { content: @avaliation.content, note: @avaliation.note, title: @avaliation.title } }
    end
  ...
  test "should update avaliation" do
    patch avaliation_url(@avaliation), params: { avaliation: { content: @avaliation.content, note: @avaliation.note, title: @avaliation.title } }
